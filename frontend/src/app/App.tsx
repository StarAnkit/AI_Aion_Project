...
export function App({ catalogApi = defaultCatalogApi, initialPublicId }: AppProps) {
  ...
  if (view.kind === 'detail') return <ArtworkDetail artwork={view.artwork} onBack={() => navigate(null)} />
